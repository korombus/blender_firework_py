...
# 再生用jsonファイル
program_json_name = FILE_ROOT_PATH + "firework_program.json"
...
# 再生用のjsonファイルを読み込んで、アニメーションに反映
with open(program_json_name, mode='r', encoding='utf-8') as f:
    firework_program = json.load(f)
